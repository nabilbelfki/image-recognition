...
For Instance A:
ssh -i "/Users/nabilbelfki/Instance A Key.pem" ec2-user@18.208.131.199
...
docker run -d -v /home/ec2-user/Output:/app/Output -e AWS_ACCESS_KEY_ID=$(aws configure get aws_access_key_id) -e AWS_SECRET_ACCESS_KEY=$(aws configure get aws_secret_access_key) -e AWS_DEFAULT_REGION=us-east-1 -e AWS_SESSION_TOKEN=$(aws configure get aws_session_token) nabilbelfki/text-recognition-app:latest
